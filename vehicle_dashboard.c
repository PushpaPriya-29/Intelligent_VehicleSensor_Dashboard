...
void draw_alerts_box(int y, int x, int height, int width);
void draw_gps_box(int y, int x);
pid_t collision_pid;
...
void screen2_input() {
    ...
    // Write destination to shared memory
...
void display_sensor_boxes(int start_y) {
    ...
    mvprintw(start_y + 4, x, "| Status: %s         |", vehicleshm->v.fuel_flag ? "LOW" : "OK ");
    ...
    mvprintw(start_y + 4, x, "| Status: %s         |", vehicleshm->v.pressure_flag ? "LOW" : "OK ");
    mvprintw(start_y + 5, x, "+--------------------+");
    attroff(COLOR_PAIR(COLOR_NORMAL));
    ...
    mvprintw(start_y + 2, x, "|--------------------|");
    mvprintw(start_y + 3, x, "| %.1f km/h         |", vehicleshm->c.relativeSpeed);
    ...
    mvprintw(start_y + 2, x, "|--------------------|");
    mvprintw(start_y + 3, x, "| RPM: %d           |", vehicleshm->v.engine_rpm);
    mvprintw(start_y + 4, x, "| Status: %s       |", vehicleshm->v.engine_flag ? "BAD" : "OK ");
    mvprintw(start_y + 5, x, "+--------------------+");
    attroff(COLOR_PAIR(COLOR_NORMAL));
}

// Display alerts from shared memory
void draw_alerts_box(int y, int x, int height, int width) {
...
void screen3_main_dashboard() {
    ...
    while (1) {
        ...
        draw_alerts_box(11, 2, 10, COLS - 52);
        draw_gps_box(11, COLS - 48);
...
void screen4_parking() {
    ...
    while (vehicleshm->p.parking_flag == 0) {
        ...
        // Display parking alerts from shared memory
        int alert_y = viz_y + 7;
        draw_alerts_box(alert_y, viz_x, 8, 70);
